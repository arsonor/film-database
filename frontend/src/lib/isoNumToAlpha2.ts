// Maps ISO 3166-1 numeric codes (as used by world-atlas topojson `id`)
// → ISO 3166-1 alpha-2 codes (as used by our backend GeographyPayload).
// Only includes the entries that can appear in our data — anything missing
// falls back to "no data" gray on the map.

export const ISO_NUM_TO_ALPHA2: Record<string, string> = {
  ...
  "434": "LY", "440": "LT", "442": "LU", "446": "MO", "450": "MG",
  "454": "MW", "458": "MY", "466": "ML", "478": "MR", "484": "MX",
  "496": "MN", "498": "MD", "499": "ME", "504": "MA", "508": "MZ",
  "512": "OM", "516": "NA", "524": "NP", "528": "NL", "554": "NZ",
  ...
  // Kosovo — not officially ISO but world-atlas uses -99 or "999"
  "-99": "XK",
};
